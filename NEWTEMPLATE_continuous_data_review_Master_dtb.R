...
setwd("//deqlab1/Vol_Data/Hylawoods/2024")

xlsx_input <- "WorkingCopy_WQM-Cont-HylaWoods-2024.xlsx"

output_dir <-"//deqlab1/Vol_Data/Hylawoods/2024/R"

xlsx_pre_check_output <- "Hylawoods24_PRECHECK.xlsx"
shiny_output <- "Hylawoods24_SHINY_CDR.Rdata"
xlsx_output <- "Hylawoods24_output.xlsx"

#changelog output
changelog <-  'Hylawoods24_changelog_Kayla'

source("//deqlab1/Vol_Data/Hylawoods/2024/R/R Scripts/cols_audit_volmon.R")
source("//deqlab1/Vol_Data/Hylawoods/2024/R/R Scripts/cols_deploy_volmon.R")
source("//deqlab1/Vol_Data/Hylawoods/2024/R/R Scripts/cols_deploy_volmon_export.R")
source("//deqlab1/Vol_Data/Hylawoods/2024/R/R Scripts/cols_deploy_volmon_forexport.R")
source("//deqlab1/Vol_Data/Hylawoods/2024/R/R Scripts/cols_prepost_volmon.R")
source("//deqlab1/Vol_Data/Hylawoods/2024/R/R Scripts/cols_projects_volmon.R")
source("//deqlab1/Vol_Data/Hylawoods/2024/R/R Scripts/contin_export_volmon_v2_1.R")
source("//deqlab1/Vol_Data/Hylawoods/2024/R/R Scripts/contin_import_volmon_v2.R")
source("//deqlab1/Vol_Data/Hylawoods/2024/R/R Scripts/mloc_col_names_volmon.R")
source("//deqlab1/Vol_Data/Hylawoods/2024/R/R Scripts/update_deploy_volmon.R")
#- Import the Data -------------------------------------------------------------
...
df5.results.2review <- df5.results.anom |>
  select(row.results, Anomaly, dt_shift, delta_per_hour, daily_min_q10, daily_max_q90, daily_mean_q10, daily_mean_q90) |>
  right_join(df5.results)
...
shiny_list <-list(Deployment=df1.deployment,
                  ...
                  Results_Anom=df5.results.2review) # changed from df5.results.anom to test if this allows for review of DQL changes 4/30/26
...
# 
# df5.results <- df4.results %>%
#      odeqcdr::dql_update(rows = c(1:7), "E", "Results collected before logger was deployed.")
# 
# 
# df4.audits.dql <- df3.audits.dql %>%
#      odeqcdr::dql_update(rows = c(1,13,19,31,37,43,49,55,84), "A", "Original audit associated with result collected before/after logger deployed/retrieved")

...
xlsx_output <- "Luckiamute2025_output_test.xlsx"
...
#- Make DQL and status edits based on Shiny Review using the function ----------

# Function to make DQL and status edits to results and audits based on Shiny Review
reviewed <- apply_logger_review(df4.results,
                                df3.audits.dql)

df5.results <- reviewed$df5.results
df4.audits.dql <- reviewed$df4.audits.dql
